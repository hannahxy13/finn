...
constexpr unsigned  PENDING = 34;  // Max. feature maps in flight
constexpr unsigned  ILEN    = 16; // Input words per IFM
constexpr unsigned  OLEN    = 1; // Output words per OFM
constexpr unsigned  KO      = 1;   // Subwords within OFM transaction word
using  TI = ap_uint<392>;  // IFM transaction word
using  TO = ap_uint<8>;  // OFM transaction word
