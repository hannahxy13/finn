...
set Library     "hls"
set IPName      "instrumentation_wrapper"
set Version     "1.0"
set DisplayName "Instrumentation_wrapper"
set Revision    "2113679617"
set Description "An IP generated by Vitis HLS"
set Device      "versal"
set AutoFamily  ""
set Taxonomy    "/VITIS_HLS_IP"
set target_part "xcvm1802-vsva2197-2MP-e-S"
set target_lang "verilog"
set has_xpm_memory "0"
set has_blackbox "false"
set sdx_kernel_type "hls"
set xo_kernel_name "instrumentation_wrapper"
set xo_kernel_files {/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/output_tfc_w1a1_VMK180/instrumentation_wrapper/top_instrumentation_wrapper.cpp}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/output_tfc_w1a1_VMK180/instrumentation_wrapper/project_instrwrap/sol1"
set debug_dir "/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/output_tfc_w1a1_VMK180/instrumentation_wrapper/project_instrwrap/sol1/.debug"
set xo_hls_files_dir "/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/output_tfc_w1a1_VMK180/instrumentation_wrapper/project_instrwrap/sol1/impl/ip/hls_files"
set hdl_module_list {instrumentation_wrapper_regslice_both
instrumentation_wrapper_fifo_w32_d34_A
instrumentation_wrapper_regslice_both
instrumentation_wrapper_fifo_w32_d3_S
instrumentation_wrapper_fifo_w8_d2_S
instrumentation_wrapper_fifo_w392_d2_S
...
set kernel_xo "/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/output_tfc_w1a1_VMK180/instrumentation_wrapper/project_instrwrap/sol1/impl/export.xo"

## Variables
set Top "instrumentation_wrapper"
set TopNoPrefix "instrumentation_wrapper"
...
set Interfaces {
    s_axi_ctrl {
        ...
        registers {{0x10 cfg W 0x0 "Data signal of cfg" {{0 32 cfg W 0 "Bit 31 to 0 of cfg"}}} {0x18 status_i W 0x0 "Data signal of status_i" {{0 32 status_i W 0 "Bit 31 to 0 of status_i"}}} {0x20 status_o R 0x0 "Data signal of status_o" {{0 32 status_o R 0 "Bit 31 to 0 of status_o"}}} {0x24 status_o_ctrl R 0x0 "Control signal of status_o" {{0 1 status_o_ap_vld R 0 "Control signal status_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 latency R 0x0 "Data signal of latency" {{0 32 latency R 0 "Bit 31 to 0 of latency"}}} {0x2c latency_ctrl R 0x0 "Control signal of latency" {{0 1 latency_ap_vld R 0 "Control signal latency_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 interval R 0x0 "Data signal of interval" {{0 32 interval R 0 "Bit 31 to 0 of interval"}}} {0x3c interval_ctrl R 0x0 "Control signal of interval" {{0 1 interval_ap_vld R 0 "Control signal interval_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 checksum R 0x0 "Data signal of checksum" {{0 32 checksum R 0 "Bit 31 to 0 of checksum"}}} {0x4c checksum_ctrl R 0x0 "Control signal of checksum" {{0 1 checksum_ap_vld R 0 "Control signal checksum_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl finnix finnox"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.3 machine 64 combinational 0 latency 3 II x}
...
source -notrace "/proj/xbuilds/SWIP/2022.2_1014_8888/installs/lin64/Vitis_HLS/2022.2/common/scripts/ipxhls.tcl"
