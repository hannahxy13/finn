...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_instrumentation_wrapper_1_0" \
 "$vpp_link_root/int/xo/ip_repo/xilinx_finn_finn_finn_design_1_0"]
set install_ip_cache "/proj/xbuilds/SWIP/2022.2_1014_8888/installs/lin64/Vitis/2022.2/data/cache/xilinx"
...
set hw_platform_info [dict create \
  ...
  hw_platform_file             "/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/instr_wrap_build/vivado/vivado_build/xsa_platform/vmk180_thin.xsa" \
  hw_platform_part             "xcvm1802-vsva2197-2MP-e-S" \
  hw_platform_vbnv             "xilinx.com:vmk180:vmk180_thin:1.0" \
  bb_locked_dcp                "" \
  bb_synth_dcp                 "" \
  ...
  dr_bd_name                   "vmk180_thin.bd" \
  dr_bd_inst_name              "" \
  top_module_name              "vmk180_thin_wrapper" \
  utilization                   $utilization \
  hw_platform_dr_bd            "" \
  hw_platform_top_bd            ".local/hw_platform/prj/vmk180_thin.srcs/sources_1/bd/vmk180_thin/vmk180_thin.bd" \
  ...
  hw_platform_board_part       "xilinx.com:vmk180:part0:3.1" \
  link_output_format           "pdi" \
  xpfm_file                    "/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/instr_wrap_build/vivado/vivado_build/xsa_platform/vmk180_thin.xsa" \
...
set config_info [dict create \
  ...
  run_script_map_file      "" \
  clbinary_name            "vmk180_thin" \
  kernels                  "finn_design instrumentation_wrapper" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs_synth            8 \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/instr_wrap_build/vitis/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \
