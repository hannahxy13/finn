...
(* CORE_GENERATION_INFO = "vmk180_thin,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=vmk180_thin,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=1,bdsource=Vitis,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "vmk180_thin.hwdef" *) 
module vmk180_thin
   ();
  ...
  wire [14:0]axi_intc_0_intr_1_interrupt_concat_dout;
  wire axi_intc_0_irq;
  wire clk_wizard_0_clk_out1;
  wire clk_wizard_0_clk_out1_o2;
  wire clk_wizard_0_locked;
  wire [7:0]finn_design_0_m_axis_0_TDATA;
  wire finn_design_0_m_axis_0_TREADY;
  wire finn_design_0_m_axis_0_TVALID;
  ...
  wire [6:0]icn_ctrl_M01_AXI_ARADDR;
  wire icn_ctrl_M01_AXI_ARREADY;
  wire icn_ctrl_M01_AXI_ARVALID;
  wire [6:0]icn_ctrl_M01_AXI_AWADDR;
  ...
  wire [391:0]instrumentation_wrapper_0_finnix_TDATA;
  wire instrumentation_wrapper_0_finnix_TREADY;
  wire instrumentation_wrapper_0_finnix_TVALID;
  wire [0:0]irq_const_tieoff_dout;
  wire [0:0]proc_sys_reset_0_peripheral_aresetn;
  wire [0:0]rst_clk_wizard_0_303M_peripheral_aresetn;
  ...
  vmk180_thin_axi_intc_0_intr_1_interrupt_concat_0 axi_intc_0_intr_1_interrupt_concat
  ...
  vmk180_thin_clk_wizard_0_0 clk_wizard_0
       (.clk_in1(CIPS_0_pl_clk0),
        .clk_out1_ce(1'b1),
        .clk_out1_clr_n(1'b1),
        .clk_out1_o2(clk_wizard_0_clk_out1_o2),
        .clk_out1_o3(clk_wizard_0_clk_out1),
        .locked(clk_wizard_0_locked),
        .resetn(CIPS_0_pl_resetn1));
  (* \ap_clk.FREQ_HZ  = "303031250" *) 
  (* \ap_clk.FREQ_HZ_TOLERANCE  = "15151562" *) 
  (* \ap_clk.refClockId  = "1" *) 
  vmk180_thin_finn_design_0_0 finn_design_0
       (.ap_clk(clk_wizard_0_clk_out1_o2),
        .ap_rst_n(rst_clk_wizard_0_303M_peripheral_aresetn),
        .m_axis_0_tdata(finn_design_0_m_axis_0_TDATA),
        .m_axis_0_tready(finn_design_0_m_axis_0_TREADY),
        .m_axis_0_tvalid(finn_design_0_m_axis_0_TVALID),
        .s_axis_0_tdata(instrumentation_wrapper_0_finnix_TDATA),
        .s_axis_0_tready(instrumentation_wrapper_0_finnix_TREADY),
        .s_axis_0_tvalid(instrumentation_wrapper_0_finnix_TVALID));
  vmk180_thin_icn_ctrl_0 icn_ctrl
       (.M00_AXI_araddr(icn_ctrl_M00_AXI_ARADDR),
        ...
        .aclk1(clk_wizard_0_clk_out1_o2),
        .aresetn(proc_sys_reset_0_peripheral_aresetn));
  (* \ap_clk.FREQ_HZ  = "303031250" *) 
  (* \ap_clk.FREQ_HZ_TOLERANCE  = "15151562" *) 
  (* \ap_clk.refClockId  = "1" *) 
  vmk180_thin_instrumentation_wrapper_0_0 instrumentation_wrapper_0
       (.ap_clk(clk_wizard_0_clk_out1_o2),
        .ap_rst_n(rst_clk_wizard_0_303M_peripheral_aresetn),
        .finnix_TDATA(instrumentation_wrapper_0_finnix_TDATA),
        .finnix_TREADY(instrumentation_wrapper_0_finnix_TREADY),
        .finnix_TVALID(instrumentation_wrapper_0_finnix_TVALID),
        .finnox_TDATA(finn_design_0_m_axis_0_TDATA),
        .finnox_TREADY(finn_design_0_m_axis_0_TREADY),
        .finnox_TVALID(finn_design_0_m_axis_0_TVALID),
        .s_axi_ctrl_ARADDR(icn_ctrl_M01_AXI_ARADDR),
        .s_axi_ctrl_ARREADY(icn_ctrl_M01_AXI_ARREADY),
        .s_axi_ctrl_ARVALID(icn_ctrl_M01_AXI_ARVALID),
        .s_axi_ctrl_AWADDR(icn_ctrl_M01_AXI_AWADDR),
        .s_axi_ctrl_AWREADY(icn_ctrl_M01_AXI_AWREADY),
        .s_axi_ctrl_AWVALID(icn_ctrl_M01_AXI_AWVALID),
        .s_axi_ctrl_BREADY(icn_ctrl_M01_AXI_BREADY),
        .s_axi_ctrl_BRESP(icn_ctrl_M01_AXI_BRESP),
        .s_axi_ctrl_BVALID(icn_ctrl_M01_AXI_BVALID),
        .s_axi_ctrl_RDATA(icn_ctrl_M01_AXI_RDATA),
        .s_axi_ctrl_RREADY(icn_ctrl_M01_AXI_RREADY),
        .s_axi_ctrl_RRESP(icn_ctrl_M01_AXI_RRESP),
        .s_axi_ctrl_RVALID(icn_ctrl_M01_AXI_RVALID),
        .s_axi_ctrl_WDATA(icn_ctrl_M01_AXI_WDATA),
        .s_axi_ctrl_WREADY(icn_ctrl_M01_AXI_WREADY),
        .s_axi_ctrl_WSTRB(icn_ctrl_M01_AXI_WSTRB),
        .s_axi_ctrl_WVALID(icn_ctrl_M01_AXI_WVALID));
  vmk180_thin_irq_const_tieoff_0 irq_const_tieoff
  ...
  vmk180_thin_rst_clk_wizard_0_303M_0 rst_clk_wizard_0_303M
       (.aux_reset_in(1'b1),
        .dcm_locked(clk_wizard_0_locked),
        .ext_reset_in(CIPS_0_pl_resetn1),
        .mb_debug_sys_rst(1'b0),
        .peripheral_aresetn(rst_clk_wizard_0_303M_peripheral_aresetn),
        .slowest_sync_clk(clk_wizard_0_clk_out1_o2));
endmodule
