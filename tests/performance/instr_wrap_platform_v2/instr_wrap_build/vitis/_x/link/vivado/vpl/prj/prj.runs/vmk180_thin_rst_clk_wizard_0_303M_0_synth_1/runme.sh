...
HD_PWD='/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/instr_wrap_build/vitis/_x/link/vivado/vpl/prj/prj.runs/vmk180_thin_rst_clk_wizard_0_303M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vmk180_thin_rst_clk_wizard_0_303M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vmk180_thin_rst_clk_wizard_0_303M_0.tcl
