...
HD_PWD='/scratch/hannayan/finn_instr_wrap_test/finn/tests/performance/instr_wrap_platform_v2/instr_wrap_build/vitis/_x/link/vivado/vpl/prj/prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vmk180_thin_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vmk180_thin_wrapper.tcl -notrace
