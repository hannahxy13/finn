...
entity instrumentation_wrapper_fifo_w32_d34_A is
    generic (
...
architecture arch of instrumentation_wrapper_fifo_w32_d34_A is

    -- component
    component instrumentation_wrapper_fifo_w32_d34_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_instrumentation_wrapper_fifo_w32_d34_A_ram : instrumentation_wrapper_fifo_w32_d34_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity instrumentation_wrapper_fifo_w32_d34_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 6;
...
architecture arch of instrumentation_wrapper_fifo_w32_d34_A_ram is
